...
//    
//     {
//       path: ROUTES.VENTAS_CONSOLIDADAS, --label modifica para otbener los items del menú
//       name: 'Ventas Consolidadas', -- label
...
//                 style={{ padding: '0.5rem', color: 'white', textWrap: 'wrap', justifyContent: menuAlign}}
                    // Modificar ROUTES.VENTAS_TEST por uno general
